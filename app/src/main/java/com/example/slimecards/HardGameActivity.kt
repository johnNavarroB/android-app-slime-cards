...
/**
 * Activity that manages the view of a game in hard mode, playing with nine cards.
 */
class HardGameActivity : AppCompatActivity(), View.OnClickListener
{
    ...
    private lateinit var card7Front : ImageView
    private lateinit var card8Front : ImageView
    private lateinit var card9Front : ImageView
    ...
    private lateinit var card7Back : ImageView
    private lateinit var card8Back : ImageView
    private lateinit var card9Back : ImageView
    ...
    private fun restore()
    {
        ...
        if ( viewModel.getCards()[6].turnedUp ) restore( card7Front, card7Back )
        if ( viewModel.getCards()[7].turnedUp ) restore( card8Front, card8Back )
        if ( viewModel.getCards()[8].turnedUp ) restore( card9Front, card9Back )
    }
    /**
    ...
    private fun goToScore()
    {
        ...
        score.putExtra( "difficulty", "hard" )
        ...
        Handler( Looper.getMainLooper() ).postDelayed(
            {
                ...
                if ( id < 2 ) delayedTurnDown( id + 1 )
                else viewModel.setViewMatrix( mutableListOf() )
            }, 550)
    }
    /**
     * Returns true if the resource identifier of the second and third cards in the view matrix are the same, false otherwise.
     */
    private fun secondPairAreEquals() : Boolean
    {
        return viewModel.getCards()[ viewModel.getViewMatrix()[1][2] as Int ].resourceId == viewModel.getCards()[ viewModel.getViewMatrix()[2][2] as Int ].resourceId
    }
    /**
     * Returns true if the resource identifier of the two first cards in the view matrix are the same, false otherwise.
     */
    private fun firstPairAreEquals() : Boolean
    {
    ...
    /**
     * Returns true if the resource identifier of the three first cards in the view matrix are the same, false otherwise.
     */
    private fun areEquals() : Boolean
    {
        return firstPairAreEquals() && secondPairAreEquals()
    }
    /**
     ...
     * @param time The period of time passed since the beginning of the game until the card is selected in milliseconds.
     */
    private fun selectCard( frontCard : View, backCard : View, id : Int, time : Long )
    {
        ...
        if ( viewModel.getViewMatrix().size == 3 && !areEquals() )
        {
            viewModel.setIsPairState( false )
            delayedTurnDown( 0 )
        } else if ( viewModel.getViewMatrix().size == 3 )
        {
    ...
    /**
     * Clicks a card and if there are four turned up pairs, sets the pair value to zero
    ...
    private fun clickCard( view : View? )
    {
        ...
        when ( view )
        {
            ...
            card7Back -> animate( card7Front, card7Back, 6, milliseconds )
            card8Back -> animate( card8Front, card8Back, 7, milliseconds )
            card9Back -> animate( card9Front, card9Back, 8, milliseconds )
        }
    ...
    private fun setBackOnClickListeners()
    {
        ...
        card7Back.setOnClickListener( this )
        card8Back.setOnClickListener( this )
        card9Back.setOnClickListener( this )
    }
    /**
    ...
    private fun setFrontImageResources()
    {
        ...
        card7Front.setImageResource( viewModel.getCards()[6].resourceId )
        card8Front.setImageResource( viewModel.getCards()[7].resourceId )
        card9Front.setImageResource( viewModel.getCards()[8].resourceId )
    }
    /**
    ...
    {
        card1Back = findViewById( R.id.firstCardHardBack )
        card2Back = findViewById( R.id.secondCardHardBack )
        card3Back = findViewById( R.id.thirdCardHardBack )
        card4Back = findViewById( R.id.fourthCardHardBack )
        card5Back = findViewById( R.id.fifthCardHardBack )
        card6Back = findViewById( R.id.sixthCardHardBack )
        card7Back = findViewById( R.id.seventhCardHardBack )
        card8Back = findViewById( R.id.eighthCardHardBack )
        card9Back = findViewById( R.id.ninthCardHardBack )
    }
    /**
    ...
    {
        card1Front = findViewById( R.id.firstCardHardFront )
        card2Front = findViewById( R.id.secondCardHardFront )
        card3Front = findViewById( R.id.thirdCardHardFront )
        card4Front = findViewById( R.id.fourthCardHardFront )
        card5Front = findViewById( R.id.fifthCardHardFront )
        card6Front = findViewById( R.id.sixthCardHardFront )
        card7Front = findViewById( R.id.seventhCardHardFront )
        card8Front = findViewById( R.id.eighthCardHardFront )
        card9Front = findViewById( R.id.ninthCardHardFront )
    }
    /**
    ...
    {
        timerButton = findViewById( R.id.stopTimeHard )
        chronometer = findViewById( R.id.chronometerHard )
