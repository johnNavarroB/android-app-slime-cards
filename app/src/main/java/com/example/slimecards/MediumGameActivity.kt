...
/**
 * Activity that manages the view of a game in medium mode, playing with eight cards.
 */
class MediumGameActivity : AppCompatActivity(), View.OnClickListener
{
    private lateinit var viewModel : MediumGameViewModel
    ...
    private fun goToScore()
    {
        ...
        score.putExtra( "difficulty", "medium" )
    ...
    {
        card1Back = findViewById( R.id.firstCardMediumBack )
        card2Back = findViewById( R.id.secondCardMediumBack )
        card3Back = findViewById( R.id.thirdCardMediumBack )
        card4Back = findViewById( R.id.fourthCardMediumBack )
        card5Back = findViewById( R.id.fifthCardMediumBack )
        card6Back = findViewById( R.id.sixthCardMediumBack )
        card7Back = findViewById( R.id.seventhCardMediumBack )
        card8Back = findViewById( R.id.eighthCardMediumBack )
    }
    /**
    ...
    {
        card1Front = findViewById( R.id.firstCardMediumFront )
        card2Front = findViewById( R.id.secondCardMediumFront )
        card3Front = findViewById( R.id.thirdCardMediumFront )
        card4Front = findViewById( R.id.fourthCardMediumFront )
        card5Front = findViewById( R.id.fifthCardMediumFront )
        card6Front = findViewById( R.id.sixthCardMediumFront )
        card7Front = findViewById( R.id.seventhCardMediumFront )
        card8Front = findViewById( R.id.eighthCardMediumFront )
    }
    /**
    ...
    {
        timerButton = findViewById( R.id.stopTimeMedium )
        chronometer = findViewById( R.id.chronometerMedium )
    ...
    {
        viewModel = ViewModelProvider( this ).get( MediumGameViewModel::class.java )
    }
    /**
