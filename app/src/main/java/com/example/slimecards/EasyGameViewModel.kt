...
/**
 * This is the view model for the game activity in easy mode.
 */
class EasyGameViewModel : ViewModel()
{
    ...
    {
        val cardImages = arrayOf( R.drawable.card_fire, R.drawable.card_fire, R.drawable.card_ice,
                                  R.drawable.card_ice, R.drawable.card_feline, R.drawable.card_feline )
        cardImages.shuffle()
        for ( i in 0 .. 5 ) getCards().add( Card(i, cardImages[i]) )
    }
    /**
